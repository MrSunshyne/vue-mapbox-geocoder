(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("vue-mapbox"), require("@mapbox/mapbox-gl-geocoder"));
	else if(typeof define === 'function' && define.amd)
		define(["vue-mapbox", "@mapbox/mapbox-gl-geocoder"], factory);
	else if(typeof exports === 'object')
		exports["vue-mapbox-geocoder"] = factory(require("vue-mapbox"), require("@mapbox/mapbox-gl-geocoder"));
	else
		root["vue-mapbox-geocoder"] = factory(root["vue-mapbox"], root["mapbox-gl-geocoder"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE__35be__, __WEBPACK_EXTERNAL_MODULE__7c06__) {
...
var mapbox_gl_geocoder_root_mapbox_gl_geocoder_ = __webpack_require__("7c06");
var mapbox_gl_geocoder_root_mapbox_gl_geocoder_default = /*#__PURE__*/__webpack_require__.n(mapbox_gl_geocoder_root_mapbox_gl_geocoder_);

// EXTERNAL MODULE: external {"commonjs":"vue-mapbox","commonjs2":"vue-mapbox","amd":"vue-mapbox","root":"vue-mapbox"}
var external_commonjs_vue_mapbox_commonjs2_vue_mapbox_amd_vue_mapbox_root_vue_mapbox_ = __webpack_require__("35be");
...
/* harmony default export */ var GeocoderControl = ({
  ...
  mixins: [external_commonjs_vue_mapbox_commonjs2_vue_mapbox_amd_vue_mapbox_root_vue_mapbox_["$helpers"].asControl],
  inject: ["mapbox", "map"],
  props: {
    ...
    $_bindSelfEvents: function $_bindSelfEvents(events) {
      ...
      keys_default()(this.$listeners).forEach(function (eventName) {
        if (events.includes(eventName)) {
          _this.control.on(eventName, vm.$_emitControlEvent.bind(vm, eventName));
        }
      });
    },
    $_emitControlEvent: function $_emitControlEvent(eventName, eventData) {
